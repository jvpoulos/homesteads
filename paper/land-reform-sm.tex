...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption{Basque Country Data, $N_t = 8$. \label{basque}} 
\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\caption{Staggered adoption}
	\end{subfigure}
	\caption{West German Reunification Data, $N_t = 8$. \label{germany}} 
\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\caption{Staggered adoption}
	\end{subfigure}
	\caption{State Government Education Spending Data, $N_t = 10$. \label{exp-pc}} 
\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\caption{Staggered adoption}
	\end{subfigure}
	\caption{State Government Expenditures Data, $N_t = 10$. \label{exp-pc}} 
\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\caption{Staggered adoption}
	\end{subfigure}
	\caption{State Government Revenues Data, $N_t = 10$. \label{exp-pc}} 
\end{figure}
...
\begin{table}[htbp]
	...
	\let\endcenter\relax
	\centering
	\resizebox{.45\width}{!}{\input{dv-table}}
\end{table}
