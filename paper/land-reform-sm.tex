...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption{Basque Country data, $N_t = 8$. See footnotes to Fig. \ref{california}. \label{basque}} 
\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\caption{Staggered adoption}
	\end{subfigure}
	\caption{West German reunification data, $N_t = 8$. See footnotes to Fig. \ref{california}. \label{germany}} 
\end{figure}
