...
Intuitively, the average RMSE decreases and confidence bands narrow as $T_0/T$ approaches one because the estimators have more information to generate counterfactual predictions. The MC-NNM 
...
The MC-NNM estimator outperforms all other estimators in the staggered adoption setting for both datasets. 

Fig. SM-\ref{synth-sim} in the Supporting Materials (SM) present results under simultaneous adoption.
...
%
% Figures SM-\ref{exp-pc} and SM-\ref{rev-pc}
