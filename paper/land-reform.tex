...
\begin{table}[htbp]
	...
	\end{center}
	\footnotesize{\emph{Notes:} randomization $p$-values calculated by Equation (\ref{eq:pvalue}) corresponding to each permutation structure and value of $\tau$ and $q$. i.i.d. block and i.i.d. block $p$-values are calculated using $|\Pi| = 1,000$ permutations. Moving block $p$-values are based on $|\Pi| = T-1$ permutations.}
\end{table}
...
%	~ 
	\begin{subfigure}[t]{0.75\textwidth}
		...
		\caption{Log per-capita state government expenditure (1982\$)}
	\end{subfigure}
	~ 
	\begin{subfigure}[t]{0.75\textwidth}
		\centering
		\includegraphics[width=\textwidth]{plots/mc-rev-pc.png}
		\caption{Log per-capita state government revenue (1982\$)}
	\end{subfigure}
