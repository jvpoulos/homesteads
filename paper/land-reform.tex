...
\begin{description}
	{\setlength\itemindent{1mm}
		...
		\item[SC-ADH] Synthetic control method approached via exponentiated gradient descent \citep{abadie2010synthetic}
...
The estimated bootstrap confidence intervals useful for evaluating per-period causal impacts but are not helpful in evaluating the overall effect of homestead policies. Table \ref{mc-estimates} reports randomization $p$-values from testing the null hypothesis of a zero effect:
