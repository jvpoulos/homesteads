...
\end{equation}
%
where $\text{states}_i$ is a vector of states dummies to control for unobserved heterogeneity across states; $d_t$ is a binary variable that takes the value of 1 at $t \geq T_0$ and after; and $\text{homesteads}_{i, t}$ is the per-capita statewide sum of homestead entries in year $t$.
