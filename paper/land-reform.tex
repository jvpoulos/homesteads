...
\begin{table}[htbp]
	...
	\end{center}
	\footnotesize{Note: values in brackets represent 95\% confidence intervals constructed by inverting the randomization test described in Section \ref{hyp-test} on $|\mathcal{A}_t| = 2,500$ null trajectories. Confidence intervals based on i.i.d. permutations are calculated using $|\Pi| = 1,000$ permuations.}
\end{table}
