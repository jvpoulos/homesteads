...
%Table \ref{placebo-tests}  shows that we cannot reject the null hypothesis at the conventional significance levels for both outcomes, all three methods, and both types of permutations. This provides evidence in favor of our model specifications and the validity of the consistency assumption.
...
%	i.i.d. & $<0.01$ & $<0.01$ & $<0.01$ & $<0.01$\\
%	i.i.d. Block & $<0.01$ & $<0.01$ & $<0.01$ & $<0.01$\\
%	Moving Block & $<0.01$ & $<0.01$ & $<0.01$ & $<0.01$ \\
%	\bottomrule
%\end{tabular}
