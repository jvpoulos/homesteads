...
S (\hat{\bar{\alpha}}_{t}) = \left(\frac{1}{\sqrt{T_\star}} \sum_{t=T_0 +1}^{T} |\hat{\bar{\alpha}}_{t}|^2\right)^2.
\end{equation}
%
...
\begin{table}[htbp]
	...
	\begin{center}
		\resizebox{.65\width}{!}{\input{mc-estimates}}
	\end{center}
	\footnotesize{\emph{Notes:} See Table \ref{placebo-tests} footnotes.}
\end{table}
