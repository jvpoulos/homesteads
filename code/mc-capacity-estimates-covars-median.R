...
# Load data
capacity.outcomes <- readRDS("capacity-outcomes-median.rds")
...
saveRDS(mc.est.w,"mc_est_w_median.rds")
...
saveRDS(moving.block.w,"moving_block_w_median.rds")
...
saveRDS(iid.block.w,"iid_block_w_median.rds")
...
saveRDS(iid.w,"iid_w_median.rds")
