TsPlotSales <- function(df, main = "") {
  ...
  geom_vline(xintercept=c(as.numeric(as.POSIXct("1866-06-01 06:00:00",tz="UTC")),
                          as.numeric(as.POSIXct("1876-06-01 06:00:00",tz="UTC"))), linetype=4) + 
