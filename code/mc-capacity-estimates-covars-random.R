...
# Load data
capacity.outcomes <- readRDS("capacity-outcomes-random.rds")
...
saveRDS(mc.est.w,"mc_est_w_random.rds")
...
saveRDS(moving.block.w,"moving_block_w_random.rds")
...
saveRDS(iid.block.w,"iid_block_w_random.rds")
...
saveRDS(iid.w,"iid_w_random.rds")