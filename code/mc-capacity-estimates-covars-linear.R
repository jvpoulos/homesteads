...
# Load data
capacity.outcomes <- readRDS("capacity-outcomes-linear.rds")
...
saveRDS(mc.est.w,"mc_est_w_linear.rds")
...
saveRDS(moving.block.w,"moving_block_w_linear.rds")
...
saveRDS(iid.block.w,"iid_block_w_linear.rds")
...
saveRDS(iid.w,"iid_w_linear.rds")
