...
census.county[[8]] <- census.county[[8]] %>%
  ...
  mutate(ns.pop = totpop-stot,
    ...
    slave.gini = gini(c(slh1,slh2,slh3,slh4,slh5,slh6,slh7,slh8,slh9,slh1014,slh1519,slh2029,slh3039,slh4049,slh5069,slh7099,slh100,slh200,slh300,slh500,slh1000)))
...
census.county[[9]] <- census.county[[9]] %>% # no avg. farm size 1870
  group_by(state,county) %>%
...
census.list <- list(census.county[[1]],census.county[[2]],census.county[[3]],census.county[[4]],census.county[[5]],census.county[[6]],
                    ...
                    census.county[[17]],census.county[[18]],census.county[[19]],census.county[[20]])

census.ts <- do.call(rbind, census.list) 

census.ts <- subset(census.ts, select=c("year","name", "county", "land.gini", "aland.gini","ns.pop","adultm","farms","farmsize"))
