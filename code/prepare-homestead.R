...
census.ts.means <- census.ts.means[c("fips","state", "county", "land.gini","aland.gini","farmsize", "tenancy","wages","output","slave.share","aa.share","native.share","white.share","year")]
